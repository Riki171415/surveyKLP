...
for i in range(3): s1.write(f'A{11+i}', ''); s1.write_number(f'B{11+i}', 0)
...
for i in range(3): s1.write(f'A{27+i}', ''); s1.write_number(f'B{27+i}', 0)
...
for i in range(15): s1.write(f'A{43+i}', ''); s1.write_number(f'B{43+i}', 0)
...
for i in range(10): s1.write(f'A{61+i}', ''); s1.write_number(f'B{61+i}', 0)
...
for i in range(2): s2.write(f'A{11+i}', ''); s2.write_number(f'B{11+i}', 0)
...
for i in range(10): s2.write(f'A{27+i}', ''); s2.write_number(f'B{27+i}', 0)
...
for i in range(5): s3.write(f'A{9+i}', ''); s3.write_number(f'B{9+i}', 0)
...
for i in range(6): s4.write(f'A{10+i}', ''); s4.write_number(f'B{10+i}', 0)
...
for i in range(6): s5.write(f'A{9+i}', ''); s5.write_number(f'B{9+i}', 0)
...
for i in range(2): s6.write(f'A{9+i}', ''); s6.write_number(f'B{9+i}', 0)
...
for i in range(5): s7.write(f'A{9+i}', ''); s7.write_number(f'B{9+i}', 0)
...
for i in range(10): s7.write(f'A{27+i}', ''); s7.write_number(f'B{27+i}', 0)
...
for i in range(7): s8.write(f'A{9+i}', ''); s8.write_number(f'B{9+i}', 0)
...
for i in range(5): s11.write(f'A{5+i}', ''); s11.write_number(f'B{5+i}', 0)
...
for i in range(5): s11.write(f'A{27+i}', ''); s11.write_number(f'B{27+i}', 0)
...
for i in range(16): s12.write(f'A{5+i}', ''); s12.write_number(f'B{5+i}', 0)
...
s13.write('A1', 'Data will be populated by JS', header_format)
