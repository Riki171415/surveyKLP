  ...
  const exportToExcel = () => {
    ...
    const rows = filteredData.map((row, index) => {
      return [
        ...
        (row.prb?.jumlah !== undefined && row.prb?.jumlah !== '') ? Number(row.prb.jumlah) : ((row.prb?.totalPeserta !== undefined && row.prb?.totalPeserta !== '') ? Number(row.prb.totalPeserta) : ''),
        (row.prb?.rutinKunjungan !== undefined && row.prb?.rutinKunjungan !== '') ? Number(row.prb.rutinKunjungan) : ((row.prb?.kunjunganRutin !== undefined && row.prb?.kunjunganRutin !== '') ? Number(row.prb.kunjunganRutin) : ''),
        row.prb?.tidakBerkunjung !== undefined && row.prb?.tidakBerkunjung !== '' ? Number(row.prb.tidakBerkunjung) : '',
        (row.prb?.peserta_dm !== undefined && row.prb?.peserta_dm !== '') ? Number(row.prb.peserta_dm) : ((row.prb?.kasus?.DM !== undefined && row.prb?.kasus?.DM !== '') ? Number(row.prb.kasus.DM) : ''),
        (row.prb?.peserta_ht !== undefined && row.prb?.peserta_ht !== '') ? Number(row.prb.peserta_ht) : ((row.prb?.kasus?.Hipertensi !== undefined && row.prb?.kasus?.Hipertensi !== '') ? Number(row.prb.kasus.Hipertensi) : ''),
        (row.prb?.peserta_jantung !== undefined && row.prb?.peserta_jantung !== '') ? Number(row.prb.peserta_jantung) : ((row.prb?.kasus?.Jantung !== undefined && row.prb?.kasus?.Jantung !== '') ? Number(row.prb.kasus.Jantung) : ''),
        (row.prb?.peserta_ppok !== undefined && row.prb?.peserta_ppok !== '') ? Number(row.prb.peserta_ppok) : ((row.prb?.kasus?.PPOK !== undefined && row.prb?.kasus?.PPOK !== '') ? Number(row.prb.kasus.PPOK) : ''),
        (row.prb?.peserta_asma !== undefined && row.prb?.peserta_asma !== '') ? Number(row.prb.peserta_asma) : ((row.prb?.kasus?.Asma !== undefined && row.prb?.kasus?.Asma !== '') ? Number(row.prb.kasus.Asma) : ''),
        (row.prb?.peserta_stroke !== undefined && row.prb?.peserta_stroke !== '') ? Number(row.prb.peserta_stroke) : ((row.prb?.kasus?.Stroke !== undefined && row.prb?.kasus?.Stroke !== '') ? Number(row.prb.kasus.Stroke) : ''),
        (row.prb?.peserta_epilepsi !== undefined && row.prb?.peserta_epilepsi !== '') ? Number(row.prb.peserta_epilepsi) : ((row.prb?.kasus?.Epilepsi !== undefined && row.prb?.kasus?.Epilepsi !== '') ? Number(row.prb.kasus.Epilepsi) : ''),
        (row.prb?.peserta_skizofrenia !== undefined && row.prb?.peserta_skizofrenia !== '') ? Number(row.prb.peserta_skizofrenia) : ((row.prb?.kasus?.Skizofrenia !== undefined && row.prb?.kasus?.Skizofrenia !== '') ? Number(row.prb.kasus.Skizofrenia) : ''),
        (row.prb?.peserta_sle !== undefined && row.prb?.peserta_sle !== '') ? Number(row.prb.peserta_sle) : ((row.prb?.kasus?.SLE !== undefined && row.prb?.kasus?.SLE !== '') ? Number(row.prb.kasus.SLE) : ''),
