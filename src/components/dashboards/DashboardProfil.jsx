  ...
  return (
    <div id="dashboard-dashboardprofil-capture" className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div id="chart-fktp-wrapper" className={`bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col relative ${isPrinting ? 'break-inside-avoid shadow-none border-slate-300' : ''}`}>
          {!isPrinting && (
            <button onClick={() => downloadElementAsPNG('chart-fktp-type', 'Proporsi_Responden_per_FKTP')} className="capture-exclude absolute top-4 right-4 p-2 bg-slate-50 text-slate-400 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition z-10" title="Download Chart PNG">
        ...
        <div id="chart-unique-wrapper" className={`bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col relative ${isPrinting ? 'break-inside-avoid shadow-none border-slate-300' : ''}`}>
          {!isPrinting && (
            <button onClick={() => downloadElementAsPNG('chart-unique-fktp', 'Proporsi_FKTP_Unik')} className="capture-exclude absolute top-4 right-4 p-2 bg-slate-50 text-slate-400 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition z-10" title="Download Chart PNG">
              <ImageIcon className="w-4 h-4" />
            </button>
          )}
          <div className="flex justify-between items-start mb-6 pr-10">
        ...
        <div id="chart-role-wrapper" className={`bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col relative ${isPrinting ? 'break-inside-avoid shadow-none border-slate-300' : ''}`}>
          {!isPrinting && (
            <button onClick={() => downloadElementAsPNG('chart-role', 'Proporsi_Jabatan')} className="capture-exclude absolute top-4 right-4 p-2 bg-slate-50 text-slate-400 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition z-10" title="Download Chart PNG">
              <ImageIcon className="w-4 h-4" />
            </button>
          )}
          <div className="flex justify-between items-start mb-6 pr-10">
        ...
        <div id="chart-regional-wrapper" className={`bg-white p-6 rounded-2xl border border-slate-100 shadow-sm lg:col-span-3 flex flex-col relative ${isPrinting ? 'break-inside-avoid shadow-none border-slate-300' : ''}`}>
          {!isPrinting && (
            <button onClick={() => downloadElementAsPNG('chart-regional', '10_Provinsi_Terbanyak')} className="capture-exclude absolute top-4 right-4 p-2 bg-slate-50 text-slate-400 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition z-10" title="Download Chart PNG">
              <ImageIcon className="w-4 h-4" />
            </button>
          )}
          <div className="flex justify-between items-start mb-6 pr-10">
