                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className={`grid grid-cols-2 sm:grid-cols-4 gap-4 p-2 rounded-2xl ${showErrors && !formData.role ? 'ring-2 ring-rose-500 bg-rose-50/50' : ''}`}>
                      {['Kepala Puskesmas / klinik', 'Dokter Umum', 'Dokter Sp.KKLP', 'Tenaga Kesehatan Fungsional (Dokter Gigi, Bidan, Perawat, Farmasi)'].map(role => (
                      ...
                      <div className="space-y-6 border-t border-blue-100 pt-6">
                        ...
                        <div>
                          ...
                          <div className={`flex flex-col gap-3 ${showErrors && !formData.spkklpStatus ? 'p-2 ring-2 ring-rose-500 rounded-xl bg-rose-50/50' : ''}`}>
                            {['PPDS', 'Rekognisi Kompetensi Lulusan (RKL) Kolegium', 'Rekognisi Pembelajaran Lampau (RPL) yang dikelola universitas'].map(opt => (
                ...
                <div className="border-t border-slate-100 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="md:col-span-2 mt-2">
                      <label className="block text-xs font-bold text-slate-800 mb-2 border-b pb-1">Jumlah peserta PRB berdasarkan diagnosis dalam Sebulan (isian angka):</label>
