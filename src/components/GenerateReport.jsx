        ...
        <div className="bg-blue-50/50 border border-blue-100 p-5 rounded-xl space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <label className="block text-sm font-semibold text-slate-800 mb-1">Gemini API Key</label>
              <p className="text-xs text-slate-500 mb-3">
                API Key hanya disimpan di browser Anda (Local Storage) dan tidak dikirim ke server kami. 
                Dapatkan API Key di <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noreferrer" className="text-primary-600 hover:underline">Google AI Studio</a>.
              </p>
              <input 
                type="password" 
                value={apiKey}
                ...
                placeholder="AIzaSy..." 
                className="w-full max-w-md px-4 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all text-sm"
              />
            </div>
          </div>
        </div>
